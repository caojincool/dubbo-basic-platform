...
public final class ExcelContext {
	...
	private SXSSFWorkbook bigDataWorkBook;
	/**
	 * 处于工作状态的工作表
	 */
	...
	public SXSSFWorkbook getBigDataWorkBook() {
		return bigDataWorkBook;
	}

	public void setBigDataWorkBook(SXSSFWorkbook bigDataWorkBook) {
		this.bigDataWorkBook = bigDataWorkBook;
	}
