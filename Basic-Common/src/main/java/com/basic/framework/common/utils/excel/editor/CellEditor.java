package com.basic.framework.common.utils.excel.editor;
...
import com.basic.framework.common.utils.excel.ExcelContext;
import com.basic.framework.common.utils.excel.editor.font.BoldFontEditor;
import com.basic.framework.common.utils.excel.editor.font.FontColorEditor;
import com.basic.framework.common.utils.excel.editor.font.FontHeightEditor;
import com.basic.framework.common.utils.excel.editor.font.ItalicFontEditor;
import com.basic.framework.common.utils.excel.editor.listener.CellValueListener;
import com.basic.framework.common.utils.excel.style.Align;
...
public class CellEditor extends AbstractEditor{
	...
	public CellEditor border(BorderStyle borderStyle, Color borderColor) {
		for (HSSFCell cell : workingCell) {
			...
			//
			tempCellStyle.setBorderBottom(borderStyle);
			tempCellStyle.setBorderTop(borderStyle);
			tempCellStyle.setBorderLeft( borderStyle);
			tempCellStyle.setBorderRight( borderStyle);
	...
	public CellEditor bgColor(Color bg) {
		return bgColor(bg, FillPatternType.SOLID_FOREGROUND);
	}
	 ...
	 * @return
	 */
	public CellEditor bgColor(Color bg, FillPatternType fillPattern) {
		for (HSSFCell cell : workingCell) {
			HSSFCellStyle style = cell.getCellStyle();
			tempCellStyle.cloneStyleFrom(style);
			//
	 ...
	 * @return
	 */
	public CellEditor align(HorizontalAlignment align){
		for (HSSFCell cell : workingCell) {
			HSSFCellStyle style = cell.getCellStyle();
			tempCellStyle.cloneStyleFrom(style);
			//
	 ...
	 * @return
	 */
	public CellEditor vAlign(VerticalAlignment align){
		for (HSSFCell cell : workingCell) {
			HSSFCellStyle style = cell.getCellStyle();
			tempCellStyle.cloneStyleFrom(style);
			//
		...
		try {
			for(StackTraceElement e : st){
				...
				for(Class clazz : interfacesList){
					if("CellValueListener".equals(clazz.getSimpleName())){
						return;
					}
				}
			}
