...
public class PinyinUtil {
	...
	public static String getPinyin(String chinese) {
		return getPinyinZhCN(convertStringByChinese(chinese));
	}
	...
	public static String getPinyinToUpperCase(String chinese) {
		return getPinyinZhCN(convertStringByChinese(chinese)).toUpperCase();
	}
	...
	public static String getPinyinToLowerCase(String chinese) {
		return getPinyinZhCN(convertStringByChinese(chinese)).toLowerCase();
	}
	...
	private static Set<String> convertStringByChinese(String chinese) {
		if (!StringUtils.isEmpty(chinese)) {
			...
			if (!"".equalsIgnoreCase(chinese.trim())) {
