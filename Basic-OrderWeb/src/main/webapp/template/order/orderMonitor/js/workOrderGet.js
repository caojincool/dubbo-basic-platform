...
ruizhi.order.workOrderGet = function() {
	
	var form1 = null;
	var _this = this;
	var URL =  WEB_ROOT + '/order/funcPage/orderMonitor/workOrderGet.do';//当前窗口的URL
	...
	return{
		...
		init : function() {
			...
			var workOrderGet = paramObj.workOrderGet;
			//alert("模态窗口内获取初始化参数："+ruizhi.ToJson(orderType));
			
			form1 = new ruizhi.FormExt("order-workOrderGet-form1");
			
			form1.objectToForm(workOrderGet);
		},	
...
ruizhi.ExecWait(function(){
	ruizhi.order.workOrderGet.init()
});