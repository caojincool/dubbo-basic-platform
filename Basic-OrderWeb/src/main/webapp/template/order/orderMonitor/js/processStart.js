...
ruizhi.order.processStart = function() {
	
	var form1 = null;
	var _this = this;
	var URL =  WEB_ROOT + '/order/funcPage/orderMonitor/processStart.do';//当前窗口的URL
	...
	return{
		...
		init : function() {
			...
			var processStartIbean = paramObj.processStartIbean;
			//alert("模态窗口内获取初始化参数："+ruizhi.ToJson(orderType));
			
			form1 = new ruizhi.FormExt("order-processStart-form1");
			
			form1.objectToForm(processStartIbean);
		},	
...
ruizhi.ExecWait(function(){
	ruizhi.order.processStart.init()
});