...
ruizhi.order.processReset = function() {
	
	var form1 = null;
	var _this = this;
	var URL =  WEB_ROOT + '/order/funcPage/orderMonitor/processReset.do';//当前窗口的URL
	...
	return{
		...
		init : function() {
			...
			var processResetIbean = paramObj.processResetIbean;
			//alert("模态窗口内获取初始化参数："+ruizhi.ToJson(orderType));
			
			form1 = new ruizhi.FormExt("order-processReset-form1");
			
			form1.objectToForm(processResetIbean);
		},	
...
ruizhi.ExecWait(function(){
	ruizhi.order.processReset.init()
});