...
<div class="modal-header bg-primary">
	...
	<h6 class="modal-title">功能按钮目录</h6>
</div>

<div class="modal-body" id="">

<!-- form -->
<form class="form-horizontal" id="oaas-funcCatalog-form1" action="#">
				...
				<div class="col-md-12">
					<fieldset>
						...
						<#--<div class="form-group">
							...
							<div class="col-lg-8">
								<div class="input-group">
									<input type="hidden" id="parentfuncCatalogId" name="parentfuncCatalogId" class="form-control">
									<input type="text" id="parentfuncCatalogName" name="parentfuncCatalogName"  class="form-control" placeholder="上级节点">
										<span class="input-group-btn">
											<button class="btn btn-primary" type="button" data-toggle="modal" onclick="ruizhi.oaas.funcCatalogDetail.selfuncCatalog()">选择</button>
										</span>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8">
								<textfuncCatalog rows="5" cols="5" class="form-control" placeholder="备注" name="remarks"></textfuncCatalog>
							</div>
						</div> -->
					</fieldset>
				</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-primary" onclick="ruizhi.oaas.funcCatalogDetail.doSubmit()">确定</button>
	<button type="button" class="btn btn-link" onclick="ruizhi.oaas.funcCatalogDetail.doClose()">关闭</button>
</div>
<!--页面foot-->
...
<!--页面脚本-->
<script type="text/javascript" src="${webRoot}/template/oaas/func/js/funcCatalogDetail.js"></script>
</html>
