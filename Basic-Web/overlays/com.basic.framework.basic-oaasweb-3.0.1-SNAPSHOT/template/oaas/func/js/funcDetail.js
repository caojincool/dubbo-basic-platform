...
ruizhi.oaas.funcDetail = function() {
	
	//私有成员
	var form1;
	var _this = this;
	var URL =  WEB_ROOT + '/oaas/funcPage/func/funcDetail.do';//当前窗口的URL
	//私有方法
	var checkCode;
	return{
		/* 初始化 */
		init : function() {
			...
			var func = paramObj.func;
			
			var catalog = paramObj.catalog;
			
			form1 = new ruizhi.FormExt("oaas-funcDetail-form1");
			...
			//修改
				...
				form1.getObject('funcCode').prop("disabled",true);
		...
		//单选目录
		selCatalog : function(){
			var url = WEB_ROOT + '/oaas/funcPage/func/selCatalog.do';
			var width = null;
			var heigth = null;
			var paramObj = {};//传给模态窗口的参数
			var submitFn = ruizhi.oaas.funcDetail.selCatalogComeBack;//模态窗口提交后回调方法
