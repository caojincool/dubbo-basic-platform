...
ruizhi.oaas.selFuncCatalog = function(){
	
	var URL =  WEB_ROOT + '/oaas/funcPage/func/selCatalog.do';//当前窗口的URL
	...
	return {
		init:function(){
			...
			//组织
			zTree1 = new ruizhi.ZTree("oaas-funcCatalog-zTree1",{
...
/*			grid_org1 = new ruizhi.DataGrid("oaas-org-grid1", {
			...
			if(ruizhi.IsNull(paramObj.title)){
				$("#oaas-selFuncCatalog-title").html(paramObj.title);
			}
...
ruizhi.ExecWait(function() {
	ruizhi.oaas.selFuncCatalog.init();
});