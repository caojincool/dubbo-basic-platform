...
ruizhi.oaas.privateDataInstDataDetail = function() {
	
	//私有成员
	var form1;
	var URL =  WEB_ROOT + '/oaas/funcPage/privateDataInstData/privateDataInstDataDetail.do';//当前窗口的URL
	var paramObj;
	//私有方法
	var checkCode;
	return{
		...
		init : function() {
			...
			form1 = new ruizhi.FormExt("oaas-privateDataInstDataDetail-form1");
...
ruizhi.ExecWait(function(){
	ruizhi.oaas.privateDataInstDataDetail.init()
});
