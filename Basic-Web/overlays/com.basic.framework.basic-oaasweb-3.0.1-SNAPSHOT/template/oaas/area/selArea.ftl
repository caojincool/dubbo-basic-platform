...
<div class="modal-header bg-primary">
	...
	<h6 class="modal-title" id="oaas-selArea-title" >单选区域窗口</h6>
</div>
	...
	<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-md-12" id="oaas-area-col1">
				...
				<table id = "oaas-area-zTree1" class="ztree" check="false" >
				</table>				
				</div>		
...
<!--页面脚本-->
<script type="text/javascript" src="${webRoot}/template/oaas/area/js/selArea.js"></script>
</html>
