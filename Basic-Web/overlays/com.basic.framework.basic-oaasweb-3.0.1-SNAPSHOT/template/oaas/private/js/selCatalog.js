...
ruizhi.oaas.selCatalog = function(){
	
	var URL =  WEB_ROOT + '/oaas/funcPage/private/selCatalog.do';//当前窗口的URL
	...
	return {
		init:function(){
			...
			//组织
			zTree1 = new ruizhi.ZTree("oaas-catalog-zTree1",{
...
/*			grid_org1 = new ruizhi.DataGrid("oaas-org-grid1", {
			...
			if(ruizhi.IsNull(paramObj.title)){
				$("#oaas-selCatalog-title").html(paramObj.title);
			}
