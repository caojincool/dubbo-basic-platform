...
ruizhi.loanAfterStatisticalReport.sellingTopList = function() {
	var fileName = "file:销冠榜.ureport.xml";
	var tableId = "sellingTopList-table";
	var formId = "sellingTopList-form";
	var form;
	...
	return {
		init : function(){
			...
			ruizhi.loanAfterStatisticalReport.sellingTopList.loadSelect();
			//初始化表格
		...
		clearData : function(){
			...
			ruizhi.loanAfterStatisticalReport.sellingTopList.submit();
		},
		loadSelect: function(){
...
ruizhi.ExecWait(function() {
	ruizhi.loanAfterStatisticalReport.sellingTopList.init();
});
