...
<#include "../includes/page-title.ftl">
	<form class="form-horizontal" id="collectionLogReport-form" action="#">
						...
						<div class="col-md-8">						
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 control-label text-right">项目编码：</label>
									<div class="col-md-8">
										<input type="text" id="projectOrderCode" name="projectOrderCode" placeholder="请输入项目编码"/>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 control-label text-right">借款人：</label>
									<div class="col-md-8">
										<input type="text" id="borName" name="borName" placeholder="请输入借款人"/>
									</div>
								</div>
							</div>
					    </div>
	...
	<div>
		<table id="collectionLogReport-table"></table>
	</div>
<!-- 引入该页面js start -->
<#include './report-table.ftl'/>
<script type="text/javascript" src="${webRoot}/template/loanAfterStatisticalReport/js/collectionLogReport.js"></script>
<!-- 引入该页面js end -->
