...
<#include "../includes/page-title.ftl">
	<form class="form-horizontal" id="riskClassificationReport-form" action="#">
							...
							<div class="form-group">
								<div class="col-lg-8">
								    <div style = "text-align:right;height:150%">
										<button type="button" class="btn btn-info" onclick="ruizhi.loanAfterStatisticalReport.riskClassificationReport.submit()"><i class="icon-search4 position-left"></i>查询</button>
										<button type="button" class="btn btn-success" onclick="ruizhi.loanAfterStatisticalReport.riskClassificationReport.clearData()"><i class="icon-x position-left"></i>清除</button>
									</div>
								</div>
						    </div>
						<div>
	...
	<div>
		<table id="riskClassificationReport-table"></table>
	</div>
<!-- 引入该页面js start -->
<#include './report-table.ftl'/>
<script type="text/javascript" src="${webRoot}/template/loanAfterStatisticalReport/js/riskClassificationReport.js"></script>
<!-- 引入该页面js end -->
