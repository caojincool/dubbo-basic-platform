...
<div id="demo-leftUpDownLayout-layout" class="easyui-layout" data-options="fit:true" style="height:650px;">
    <div data-options="region:'north',title:'查询条件',split:true,border:false" style="height:183px;">
    
<!-- 上面查询form表单 start -->
<form class="form-horizontal" id="demo-leftUpDownLayout-form1" action="#">
					...
					<div class="navbar navbar-default navbar-xs">
						<div class="navbar-collapse collapse" id="navbar-filter">
							<ul class="nav nav-tabs nav-tabs-solid">
								<li><a href="javascript:ruizhi.demo.leftUpDownLayout.loadData()"><i class="icon-search4 position-left"></i>查询</a></li>
								<li><a href="javascript:ruizhi.demo.leftUpDownLayout.loadData()"><i class="icon-plus2 position-left"></i>新增</a></li>
								<li><a href="javascript:ruizhi.demo.leftUpDownLayout.loadData()"><i class="icon-bianji position-left"></i>编辑</a></li>
								<li><a href="javascript:ruizhi.demo.leftUpDownLayout.loadData()"><i class="icon-x position-left"></i>作废</a></li>							
							</ul>
						</div>
					</div>
<!-- 中间按钮 end -->
    ...
    <div data-options="region:'west',title:'查询条件',split:true,border:false" style="width:150px;">
		<table id="demo-leftUpDownLayout-zTree1" class="ztree">
		</table>
    </div>
    <div data-options="region:'center',title:'查询结果'" style="padding:5px">
<!-- 下面展示数据table start -->
<table id="demo-leftUpDownLayout-grid1" showCheck="true" idPropertyName="leftUpDownLayout"
 rowNum="10" pagerid="demo-leftUpDownLayout-page1"><!--onItemDblClick="itemDblClick"-->
	<tr>
...
<div id="demo-leftUpDownLayout-page1"></div>
<!-- 下面展示数据table end -->
    </div>
</div>
...
<!-- 引入该页面js start -->
<script type="text/javascript" src="${webRoot}/template/demo/js/leftUpDownLayout.js"></script>
<!-- 引入该页面js end -->
