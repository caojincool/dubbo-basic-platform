...
ruizhi.oaas.menuCatalogDetail = function() {
	
	//私有成员
	var form1;
	var _this = this;
	var URL =  WEB_ROOT + '/oaas/funcPage/menuCatalog/catalogDetail.do';//当前窗口的URL
	//私有方法
	var checkCode;
	return{
		/* 初始化 */
		init : function() {
			...
			var menuCatalog = paramObj.menuCatalog;
			
			form1 = new ruizhi.FormExt("oaas-menuCatalog-form1");
			form1.objectToForm(menuCatalog);
		},	
...
ruizhi.ExecWait(function(){
	ruizhi.oaas.menuCatalogDetail.init()
});
