...
<!-- form -->
<form class="form-horizontal" id="oaas-roleCatalog-form1" action="#">
				...
				<div class="col-md-12">
					<fieldset>
						...
						<#--<div class="form-group">
							...
							<div class="col-lg-8">
								<div class="input-group">
									<input type="hidden" id="parentroleCatalogId" name="parentroleCatalogId" class="form-control">
									<input type="text" id="parentroleCatalogName" name="parentroleCatalogName"  class="form-control" placeholder="上级节点">
										<span class="input-group-btn">
											<button class="btn btn-primary" type="button" data-toggle="modal" onclick="ruizhi.oaas.roleCatalogDetail.selroleCatalog()">选择</button>
										</span>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8">
								<textroleCatalog rows="5" cols="5" class="form-control" placeholder="备注" name="remarks"></textroleCatalog>
							</div>
						</div> -->
					</fieldset>
				</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-primary" onclick="ruizhi.oaas.roleCatalogDetail.doSubmit()">确定</button>
	<button type="button" class="btn btn-link" onclick="ruizhi.oaas.roleCatalogDetail.doClose()">关闭</button>
</div>
<!--页面foot-->
...
<!--页面脚本-->
<script type="text/javascript" src="${webRoot}/template/oaas/role/js/roleCatalogDetail.js"></script>
</html>
