...
//		
		...
		childrenMenu12.setMenuId(12L);
		childrenMenu12.setMenuName("ajax方法测试");
		childrenMenu12.setMenuUrl("demo/menuPage/demoAjax.do");
		children.add(childrenMenu12);
		
		DemoMenu childrenMenu13 = new DemoMenu();
		childrenMenu13.setMenuId(13L);
		childrenMenu13.setMenuName("上下布局");
		childrenMenu13.setMenuUrl("demo/menuPage/upDownLayout.do");
		children.add(childrenMenu13);
		
		DemoMenu childrenMenu14 = new DemoMenu();
		childrenMenu14.setMenuId(14L);
		childrenMenu14.setMenuName("左上下布局");
		childrenMenu14.setMenuUrl("demo/menuPage/leftUpDownLayout.do");
		children.add(childrenMenu14);
		
		DemoMenu childrenMenu15 = new DemoMenu();
		childrenMenu15.setMenuId(15L);
		childrenMenu15.setMenuName("layout布局使用");
		childrenMenu15.setMenuUrl("demo/menuPage/uiLayout.do");
		children.add(childrenMenu15);
//		
//		
///*		DemoMenu childrenMenu11 = new DemoMenu();
//		childrenMenu11.setMenuId(11L);
...
//		menuTreeList.add(menu2);
		...
		DemoCatalog catalog2 = new DemoCatalog();
		catalog2.setCatalogName("目录1");
		catalog1.setChildObj(new ArrayList<Object>(children));
		
		
		List<DemoCatalog> catalogs = new ArrayList<DemoCatalog>();
		
		DemoCatalog catalog3 = new DemoCatalog();
		catalog3.setCatalogName("目录12");
		
		catalogs.add(catalog3);
		
		catalog2.setChildObj(new ArrayList<Object>(catalogs));
		
		
		menuTreeList.add(catalog1);
		menuTreeList.add(catalog2);
