...
package com.creatson.${system}.${package}.manager.impl;
...
import com.creatson.${system}.${package}.dao.${subtable.variables.class}Dao;
import com.creatson.${system}.${package}.model.${subtable.variables.class};
</#list>
</#if>
import com.hotent.base.db.api.Dao;
import com.hotent.base.manager.impl.AbstractManagerImpl;
import com.creatson.${system}.${package}.dao.${class}Dao;
import com.creatson.${system}.${package}.model.Default${class};
import com.creatson.${system}.${package}.manager.${class}Manager;
